...
class TestGamePlay(unittest.TestCase):
    ...
    @patch('Python.game_play.GamePlay.add_round_to_game_history')
    def test_playRound_callsaddRoundToGameHistoryWithCorrectParams(self, mock):
        ...
        self.subject.play_round(*self.players,
        ...
        p2_payoff = self.subject.get_row_players_payoffs(p2_action, p1_action)
    ...
    def test_getPlayerPayoffs_returnsProperPdPayoffs(self):
        ...
        self.assertEqual(self.subject.get_row_players_payoffs(1, 1), 1)
        self.assertEqual(self.subject.get_row_players_payoffs(0, 0), 2)

    def test_pairUpPopulation_returnsHalfLengthOfPlayers_givenEvenPlayer(self):
        self.assertEqual(
            len(self.subject.pair_up_population()),
    ...
    def test_pairUpWholePopulation_returnsListOfTuplesWithTwoPlayerEach(self):
        for pair in self.subject.pair_up_population():
    ...
    def test_pairUpPopulation_callsShuffleOnPlayers(self, mock):
        self.subject.pair_up_population()
        self.assertEqual(
